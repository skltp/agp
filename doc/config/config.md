...
För mer information om hur användare och lösenord för Hawtio konfigureras samt exempelfiler,
se [Detaljerad konfiguration].
Loggning och hur det går till och kan konfigureras kan man läsa om här: [Loggning konfigurering]

### Application.properties ###

Spring-boot property fil som ligger under resources i jaren. Inställningarna kan överlagras enligt de sätt som
Spring-boot föreskriver.
...
| vp.validationLog.services                          | GetAggregatedCareDocumentation-v3                                                                 | Lista med aggregerande tjänster för vilka validering mot schema och loggning ska ske                    |
| vp.validationLog.interval                          | 60000                                                                                             | Intervall för loggning                                                                                  |
| vp.validationLog.hashStrategy                      | sha256                                                                                            | Hash-strategi för valideringsmeddelanden: 'sha256' (default) eller 'noop' (ingen hashing)                |
