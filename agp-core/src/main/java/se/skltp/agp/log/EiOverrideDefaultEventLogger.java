...
public class EiOverrideDefaultEventLogger implements EventLogger, MuleContextAware {
    ...
    private static final Logger log = LoggerFactory.getLogger(EiOverrideDefaultEventLogger.class);
    ...
    public EiOverrideDefaultEventLogger() {
...
//      dispatchEvent("soitoolkit-error-log-endpoint", msg);
    ...
    /*
     * NOTE!
     * This is a full copy of the soi-toolkit DefaultEventLogger with the change that
     * dispatchEvent(String, String) is protected instead of private. This is needed
     * to be able for CustomEventLogger to override the dispatchErrorEvent(String)
     * and dispatchInfoEvent(String) according to https://code.google.com/p/soi-toolkit/wiki/UG_CustomizeLogging,
