...
public class MessageOutInterceptor extends AbstractPhaseInterceptor<Message> {
  ...
  public class LoggingCallback implements CachedOutputStreamCallback {
    ...
    public LoggingCallback(final MessageLogEventSender sender, final Message msg, final OutputStream os, int limit) {
      this.sender = sender;
      this.message = msg;
      this.origStream = os;
    ...
    protected void writePayload(StringBuilder builder, CachedOutputStream cos, String encoding) throws IOException {
